        ...
        <main className="support">
            ...
            <div className="mx-auto w-11/12 p-10 my-10 md:text-center shadow-md grid md:gap-10 md:grid-cols-3">
                ...
                <div className="call my-5">
                    <FontAwesomeIcon icon={faPhone} className="text-xl text-blue-700" />
                ...
                <div className="address my-5">
                    <FontAwesomeIcon icon={faLocationDot} className="text-xl text-blue-700" />
            ...
            <div className="contact w-11/12 mx-auto p-2">
                <div className="contact-container md:flex justify-center items-center">
                    <div className="image md:w-5/12">
                        <img src="" alt="Contact Image" className="w-10/12" />
                    </div>
                    <div className="form md:w-5/12 border px-6 py-7 bg-slate-50/70">
                        <form>
                            ...
                            <div className="mb-3">
                                <input type="text" name="phone" id="phone" placeholder="Phone" className="p-3 rounded-md border w-full" />
                            </div>
                            <div className="mb-3">
                                <textarea name="message" id="message" placeholder="message" className="p-3 rounded-md border w-full"></textarea>
                            </div>
                            <div className="mb-3">
                                <input type="submit" value="Send" className="py-3 px-10 mx-auto block text-white rounded-md border-2 bg-blue-700" />
                            </div>
                        </form>
                    </div>
                </div>
